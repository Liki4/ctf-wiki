...
因此在接下来的章节中，笔者将详细叙述 AI Agent 的基本工程原理，并以 [https://github.com/A3INFRA/Flagent](https://github.com/A3INFRA/Flagent) 、[https://github.com/verialabs/ctf-agent](https://github.com/verialabs/ctf-agent)、[https://github.com/NYU-LLM-CTF/nyuctf_agents](https://github.com/NYU-LLM-CTF/nyuctf_agents)、[https://github.com/openai/codex](https://github.com/openai/codex) 等开源项目为例讲述如何 **从零开始构建一个 AI Agent 以解决安全领域的问题**，包括自动化的渗透测试、漏洞挖掘与利用等——自然也包括如何解 CTF 题目。
